...
Findmyacco is an intercontinental housing platform that assists students with top-tier accommodations within range of their universities.
          ...
          <Stack align={'flex-start'}>
            ...
            <Flex color='white'>
            <Box mt={"3px"} >
    <AiFillHome  color='rgb(244,180,26)'/> </Box>
    <Box ml={"5px"}>
     <Text >ADDRESS</Text>
     <Text w={"50%"} color="rgb(133,135,138)">F-38 Shukan mall shahibaug ahmedabad Pin-380004</Text>
  </Box>
            </Flex>
            </Stack>
            <Stack direction={'row'}>
            <Flex color='white'>
            <Box mt={"3px"} >
    <MdEmail  color='rgb(244,180,26)'/> </Box>
    <Box ml={"5px"}>
     <Text >EMAIL:</Text>
     <Text color="rgb(133,135,138)">contact@findmyacco.com</Text>
            ...
            <Flex color='white'>
            <Box mt={"3px"} >
    <AiFillPhone color='rgb(244,180,26)'/> </Box>
    <Box ml={"5px"}>
     <Text >PHONE:</Text>
