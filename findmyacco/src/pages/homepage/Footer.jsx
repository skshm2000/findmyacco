    ...
    <Box className="w-full b-0 sticky h-full">
      ...
      >
        <Container as={Stack} maxW={"6xl"} py={10}>
          ...
          >
            <Stack spacing={6}>
              <Box fontSize={"22px"} color="white">
                ABOUT US
              </Box>
              <Text fontSize={"sm"} color="rgb(133,135,138)">
                Findmyacco is an intercontinental housing platform that assists
                students with top-tier accommodations within range of their
                universities.
              </Text>
            ...
            <Stack align={"flex-start"}>
              ...
              <Link className="footerLink" to={"/host_a_home"}>
                Host A Home
              </Link>
              ...
              <Link className="footerLink" to={"/scholarships"}>
                Scholarships
              </Link>
            </Stack>
            <Stack align={"flex-start"}>
            ...
            <Stack align={"flex-start"}>
              ...
              <Stack direction={"row"}>
                <Flex color="white">
                  <Box mt={"3px"}>
                    <AiFillHome color="rgb(244,180,26)" />{" "}
                  </Box>
                  <Box ml={"5px"}>
                    <Text>ADDRESS</Text>
                    <Text w={"50%"} color="rgb(133,135,138)">
                      F-38 Shukan mall shahibaug ahmedabad Pin-380004
                    </Text>
                  </Box>
                </Flex>
              </Stack>
              <Stack direction={"row"}>
                <Flex color="white">
                  <Box mt={"3px"}>
                    <MdEmail color="rgb(244,180,26)" />{" "}
                  </Box>
                  <Box ml={"5px"}>
                    <Text>EMAIL:</Text>
                    <Text color="rgb(133,135,138)">contact@findmyacco.com</Text>
                  </Box>
                </Flex>
              </Stack>
              <Stack direction={"row"}>
                <Flex color="white">
                  <Box mt={"3px"}>
                    <AiFillPhone color="rgb(244,180,26)" />{" "}
                  </Box>
                  <Box ml={"5px"}>
                    <Text>PHONE:</Text>
                    <Text color="rgb(133,135,138)">9537042701</Text>
                  </Box>
                </Flex>
              </Stack>
            </Stack>
